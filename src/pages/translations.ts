const translations = {
  en: {
    ...
    about: {
      ...
      p1_desc: "Every campaign starts with a discovery session to map cultural footprints and align your brand's vision.",
  ...
  es: {
    ...
    about: {
      ...
      p1_desc: "Cada campaña comienza con una sesión de descubrimiento para mapear la huella cultural y alinear la visión.",
