    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      {/* Modals */}
        ...
        <ContentModal 
          ...
          onTwitchUpload={async (file, creatorId, dCount, aCount, pCount, uvCount, uChatters, vCount, fCount, sCount) => {
            await handleTwitchUpload(file, user?.id || '', creatorId || null, editingContent as any, campaigns, dCount, aCount, pCount, uvCount, uChatters, vCount, fCount, sCount);
          }}
          onSubmit={async (data) => {
