                ...
                {filteredContent.map(item => {
                  ...
                  return (
                    <motion.a 
                      ...
                      className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden group hover:shadow-xl hover:bg-blue-50 hover:border-blue-200 transition-all duration-300 block cursor-pointer"
                    >
                    <div className="p-4">
