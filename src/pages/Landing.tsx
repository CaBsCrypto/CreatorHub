...
const ProcessBox = ({ step, onClick }: { step: any, onClick: () => void }) => (
  <motion.div 
    ...
    onClick={onClick}
    className="relative p-7 rounded-[1.5rem] bg-[#030711]/60 border border-white/10 backdrop-blur-3xl cursor-pointer group transition-all duration-500 overflow-hidden min-h-[220px] flex flex-col justify-between"
  >
  ...
  return (
    <div className="landing-container selection:bg-emerald-500/30">
      ...
      <section id="onboarding" className="pt-4 pb-32 px-8 lg:px-12 bg-[#030711] relative z-10 overflow-hidden">
        {/* BACKGROUND SOCIAL PROOF: THE SWEET SPOT (HIGH VISIBILITY + READABILITY) */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
           {/* Sophisticated Overlays */}
           <div className="absolute inset-0 bg-gradient-to-b from-[#030711] via-transparent to-[#030711] z-20" />
           <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_40%,#030711_90%)] z-20" />
           ...
           >
              {[...CREATORS, ...CREATORS, ...CREATORS, ...CREATORS].map((creator, i) => (
                <div key={i} className="flex-none w-[380px] h-[480px] rounded-[3rem] overflow-hidden grayscale brightness-[0.4] contrast-[1.2]">
