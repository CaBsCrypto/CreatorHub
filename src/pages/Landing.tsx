  ...
  return (
    <div className="landing-container umbra-red-aesthetic overflow-x-hidden">
      ...
      <main className="relative z-10">
        ...
        <section className="pt-32 pb-16 px-8 lg:px-12 min-h-[90vh] flex flex-col justify-center relative overflow-hidden">
           {/* Section Aura */}
           <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-red-600/[0.04] blur-[200px] -z-10" />
           ...
           <div className="max-w-7xl mx-auto w-full">
              ...
              >
                 <div className="space-y-8">
                    ...
                    <h1 className="text-7xl md:text-[9rem] font-black uppercase tracking-tighter leading-[0.85] text-white">
                       Beyond <br/>
                 ...
                 <div className="pt-20 grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-white/5 opacity-40 hover:opacity-100 transition-opacity duration-700" ref={statsRef}>
        ...
        <section id="creators" className="py-24 border-y border-white/5 overflow-hidden relative bg-[#010101]">
           <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-red-600/[0.03] blur-[150px] pointer-events-none" />
           <div className="max-w-7xl mx-auto px-8 lg:px-12 mb-12 flex justify-between items-end relative z-10">
              <div className="space-y-4">
                 <span className="text-[10px] font-black text-red-500 uppercase tracking-[0.8em]">The_Elite_Guild</span>
                 <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter leading-none text-white">Force of <span className="text-red-500">Nature.</span></h2>
              </div>
           </div>
        ...
        <section id="method" className="py-24 px-8 lg:px-12 border-b border-white/5 bg-transparent relative">
          <div className="absolute top-1/2 left-1/4 w-full h-full bg-red-600/[0.04] blur-[180px] pointer-events-none -translate-y-1/2" />
          
          <div className="max-w-7xl mx-auto relative z-10">
             <div className="mb-20 space-y-6">
                <span className="text-[10px] font-black text-red-500 uppercase tracking-[0.8em]">Operational_Infrastructure</span>
                <h2 className="text-6xl md:text-7xl font-black uppercase tracking-tighter leading-none text-white">The Umbra <span className="text-red-500 italic">Method.</span></h2>
        ...
        <section id="leadership" className="py-24 px-8 lg:px-12 bg-transparent relative">
          <div className="absolute bottom-0 right-0 w-full h-full bg-red-900/[0.03] blur-[150px] pointer-events-none" />
          <div className="max-w-7xl mx-auto relative z-10">
