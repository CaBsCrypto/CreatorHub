  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center justify-between w-full rounded-xl border border-slate-200 bg-white/5 py-2.5 px-4 text-sm font-medium text-white focus:ring-2 focus:ring-emerald-500/20 focus:bg-white/10 transition-all outline-none text-left"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-2 border-b border-slate-200 flex items-center gap-2 sticky top-0 bg-white backdrop-blur-md">
