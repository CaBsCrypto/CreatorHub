...
const TwitchStatsModal: React.FC<TwitchStatsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl rounded-[2.5rem] bg-slate-950/80 backdrop-blur-xl p-8 shadow-2xl ring-1 ring-white/10 border border-white/5 animate-in zoom-in-95 slide-in-from-bottom-8 duration-300 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="relative aspect-video rounded-3xl overflow-hidden bg-white/5 border border-white/10 shadow-inner">
            {previewImage ? (
            ...
            {isAnalyzing && (
              <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-md flex items-center justify-center flex-col gap-4">
          ...
          <div className="space-y-6">
            <h3 className="text-[10px] font-black text-white uppercase tracking-[0.2em] flex items-center gap-2">
              Extraction Results {stats && <CheckCircle2 className="h-4 w-4 text-emerald-500" />}
            </h3>
        ...
        <div className="flex gap-4">
          <button
            onClick={onClose}
            className="flex-1 px-8 py-4 rounded-2xl border border-white/10 text-[10px] font-black text-slate-500 uppercase tracking-widest hover:bg-white/5 transition-all"
          >
            Abort
          </button>
          <button
