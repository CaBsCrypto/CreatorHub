        ...
        <form onSubmit={onSubmit} className="space-y-6 pb-2">
          <div>
            ...
            <input
              type="text"
              required
              className="block w-full rounded-2xl border-white/10 bg-white/5 py-3 px-4 text-sm font-medium text-white focus:ring-2 focus:ring-emerald-500/50 focus:bg-white/10 focus:border-emerald-500/50 transition-all outline-none"
          ...
          <div>
            ...
            <textarea
              className="block w-full rounded-2xl border-white/10 bg-white/5 py-3 px-4 text-sm font-medium text-white focus:ring-2 focus:ring-emerald-500/50 focus:bg-white/10 focus:border-emerald-500/50 transition-all outline-none resize-y min-h-[100px]"
              rows={3}
          ...
          <div>
            ...
            <input
              type="number"
              step="0.01"
              className="block w-full rounded-2xl border-white/10 bg-white/5 py-3 px-4 text-sm font-medium text-white focus:ring-2 focus:ring-emerald-500/50 focus:bg-white/10 focus:border-emerald-500/50 transition-all outline-none font-mono"
              placeholder="0.00"
          ...
          <div className="bg-indigo-500/5 p-5 rounded-[2rem] border border-indigo-500/20">
            ...
            <input
              type="text"
              className="block w-full rounded-2xl border-white/10 bg-white/5 py-3 px-4 text-sm font-black text-indigo-400 focus:ring-2 focus:ring-indigo-500/50 transition-all outline-none shadow-sm font-mono"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 max-h-40 overflow-y-auto pr-2 custom-scrollbar">
              {creators.map(creator => (
                <label key={creator.id} className="flex items-center gap-3 p-3 rounded-2xl border border-white/5 bg-white/5 hover:bg-white/10 hover:border-indigo-500/30 transition-all cursor-pointer group">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-white/20 bg-white/5 text-emerald-500 focus:ring-emerald-500/50 transition-all cursor-pointer"
                  ...
                  />
                  <span className="text-xs font-bold text-slate-300 group-hover:text-emerald-400 transition-colors truncate">
